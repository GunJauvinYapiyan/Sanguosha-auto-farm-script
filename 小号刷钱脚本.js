...
var PANEL = {
    ...
    LOBBY_ENTER_FARM_BTN: [1535, 290]  // 进农场的坐标（新号有七日礼的横坐标改为1800）
};
...
// 【已改动】：删去最外圈第一圈（l1），直接切入第二圈（TL2）开始旋转
function dragFarmLoop(key) {
    ...
    // 直接从中心进入第二圈起点
    points = points.concat(generateLine(CONFIG.CENTER_TILE, TL2, scaleSteps(BASE_STEPS.entry, p.loop2Ms)));
